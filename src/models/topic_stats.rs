...
pub struct TopicStats {
    ...
    pub publishers: Option<Vec<crate::models::PublisherStats>>,
    #[serde(rename = "subscriptions", skip_serializing_if = "Option::is_none")]
    pub subscriptions: Option<::std::collections::HashMap<String, crate::models::SubscriptionStats>>,
    #[serde(rename = "replication", skip_serializing_if = "Option::is_none")]
    pub replication: Option<::std::collections::HashMap<String, crate::models::ReplicatorStats>>,
